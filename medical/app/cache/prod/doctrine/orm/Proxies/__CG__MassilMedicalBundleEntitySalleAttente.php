 ...
 */
class SalleAttente extends \Massil\MedicalBundle\Entity\SalleAttente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'date', 'patientSalleAttentes');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SalleAttente $proxy) {
