 ...
 */
class RechercheAvance extends \Massil\MedicalBundle\Entity\RechercheAvance implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'search', 'age', 'date', 'etatCivil', 'sexe', 'assurance');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RechercheAvance $proxy) {
    ...
    public function setAssurance($assurance)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAssurance', array($assurance));
    ...
    public function getAssurance()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAssurance', array());
