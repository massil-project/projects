 ...
 */
class Antecedant extends \Massil\MedicalBundle\Entity\Antecedant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'type', 'contenu', 'dateAjoute', 'patient');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Antecedant $proxy) {
    ...
    public function setDateAjoute($dateAjoute)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDateAjoute', array($dateAjoute));
    ...
    public function getDateAjoute()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDateAjoute', array());
